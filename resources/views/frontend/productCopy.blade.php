                    ...
                    <div class="item-list">
                      <div class="row">
                        ...
                        <div class="col-md-3 text-center  price-box">
                          ...
                          <div style="clear: both"></div>
                          <form role="form" name="addToCart" method="POST" action="{{ url($empSlug.'/cart') }}" >
                            @csrf
                            <input type="hidden" name="p_id" value="{{ $prod->id }}">
                            <input type="hidden" name="qty" value="1">
                            <button type="submit"  class="btn btn-warning">Agregar <i class="fa fa-shopping-basket"></i></button>
                          </form>
                        </div>  
                      </div>
                    </div>
